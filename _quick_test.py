...
results.append(('tier6', c.is_incapacitated() == True))

c2 = Character(name='T')
c2.statuses['被打晕'] = Status(name='被打晕', current_tier=2, ticked_boxes={1,2})
results.append(('explicit_name', c2.is_incapacitated() == True))

c3 = Character(name='T')
c3.statuses['受伤'] = Status(name='受伤', current_tier=3, ticked_boxes={1,2,3})
results.append(('low_tier', c3.is_incapacitated() == False))

c4 = Character(name='T')
results.append(('no_statuses', c4.is_incapacitated() == False))
