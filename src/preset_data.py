...
DEMO_CHALLENGE = Challenge(
    ...
    threats=[
        "歪了歪头，电子烟在空中画了个弧——保镖会意，向前迈出一步，骨节咔嗒作响，形成无声威慑",
        "提高嗓门，故意让周围卡座的客人听清——「你以为没人知道你在替你老板擦屁股？」——在公共场合施加社交压力",
        "手指滑向桌下，一把隐藏的袖枪悄然上膛——Miko 的指尖停在扳机护圈上，从未真正信任过任何人",
        "指尖轻敲隐藏在耳后的微型耳麦，低声吐出几个字——「后巷，两个」——增援可能已经在路上了",
        "冷笑一声，靠回卡座的裂痕人造皮革，向门口抬了抬下巴——谈判结束了，「你的情报不值钱，Kael。下次带真货来。」",
    ],
    notes=(
        "威胁→后果参考（供后果Agent使用）：\n"
