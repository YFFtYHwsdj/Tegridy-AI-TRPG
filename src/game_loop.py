...
class GameLoop:
    ...
    def _transition_scene(self):
        """执行场景过渡流水线。"""
        self.scene_transition_pipeline.execute(self._transition_hint)
        self._open_scene()
