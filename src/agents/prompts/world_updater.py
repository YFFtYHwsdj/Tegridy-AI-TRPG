...
【封杀玩家节点】：
- 主角（Kael）由独立的状态引擎管理，**绝对禁止**将 Kael 作为 source_id 或 target_id 写入关系图中！对于物品，只要写在 Kael 手中即可，不要建立连线。
...
【关系提取克制原则】：
- 【仅允许提取的关系】：血海深仇、长期的利益结盟、所有权变更、从属帮派派系。其他一切一律不提取。
- 仅记录与主线剧情、主角行动直接相关的重要且长期的关系变化。
